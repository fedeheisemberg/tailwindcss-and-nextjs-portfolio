      ...
      <div className="my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2">
            <h1 className="text-center text-2xl font-bold mb-6 md:text-left lg:text-3xl">
              ¡Conóceme!
            </h1>
            <p className="text-lg mt-4 mb-6 md:text-2xl lg:text-3xl">
            ...
            <p>
              ...
              <span className="font-bold text-teal-500 lg:text-xl">
          ...
          <div className="md:w-1/2">
            <div className="text-center md:w-full md:text-left">
              <h1 className="text-2xl font-bold mb-6 lg:text-3xl">Mis habilidades</h1>
              <div className="flex flex-wrap flex-row justify-center z-10 md:justify-start">
                {skills.map((item, idx) => (
                  <p
                    key={idx}
                    className="bg-gray-200 px-4 py-2 mr-2 mt-2 text-gray-500 rounded font-semibold lg:text-lg"
                  >
                    {item.skill}
                  </p>
                ))}
        ...
        <div className="flex flex-col items-center justify-center md:w-full">
          <br />
          <h1 className="text-center text-2xl font-bold mb-6 lg:text-3xl">
          ...
          <p>
            Si necesitas ayuda, asesoramiento o solucionar un problema de datos, no dudes en contactarme. Estoy para ayudarte.
          </p>
          <a
            href="mailto:fedemarti0107@gmail.com"
            className="inline-block mt-4 bg-teal-500 text-white font-bold py-2 px-4 rounded hover:bg-teal-600 transition-colors lg:py-3 lg:px-6"
          >
            Contáctame
          </a>
        </div>
